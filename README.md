...
项目同时提供 OSS 文件浏览与管理能力（上传、下载、删除、重命名、复制、移动、获取地址、双击预览），可按整个账号或预设路径查看内容，适合软件发布、构建产物归档、资源同步和日常文件管理。
...
6. 在“OSS 文件”中按账号或预设路径浏览内容，可下载、删除、重命名、复制 / 移动对象，上传本地文件到当前目录，或双击文本、图片文件直接预览内容。
